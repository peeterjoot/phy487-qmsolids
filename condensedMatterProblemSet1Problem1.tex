...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterProblemSet1:20}
\Bp = \int \Bx' \rho(\Bx') d^3 x'
\end{equation}
\begin{equation}\label{eqn:condensedMatterProblemSet1:40}
\BE =
...
\end{dmath}
%
Here we see explicitly the \(1/r^6\) dependence of the field due to both the oscillation of the dipole \(\Bp\) of the atom itself, as well the polarizability \(\alpha\) of its neighbour.
}
