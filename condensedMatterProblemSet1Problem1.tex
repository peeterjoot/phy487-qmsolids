...
%
\begin{equation}\label{eqn:condensedMatterProblemSet1:60}
\BE =
\lr{
3 \Bn (\Bn \cdot \Bp) - \Bp)
}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet1:80}
\Bp = \alpha \BE.
\end{equation}
%
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet1:100}
\begin{aligned}
\BE' &=
\lr{
3 \Bn' (\Bn' \cdot \BE) - \BE
