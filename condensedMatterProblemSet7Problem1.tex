...
\end{dmath}
%
Now consider the integral of the derivative, taking some care in the neighbourhood \(\Abs{E - \mu} < \epsilon\).  We have
%
...
\end{equation}
%
Here we (rather loosely) consider \(\epsilon\) fixed, and allow \(\tau \rightarrow 0\) for that choice of \(\epsilon\).  This leaves only the integral in the neighbourhood of \(\mu\), which we find is unity as expected.
