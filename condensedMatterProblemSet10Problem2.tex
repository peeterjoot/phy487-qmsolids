...
%
\makeoproblem{Doped carrier density.}{condensedMatter:problemSet10:2}{2013 ps10 p2}{
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet10Problem2:20}
n \approx 2 N_{\txtD}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet10Problem2:40}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet10Problem2:60}
\begin{aligned}
N_{\mathrm{eff}}^{\txtC}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet10Problem2:80}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet10Problem2:100}
\begin{aligned}
n
&\approx
2 N_{\txtD}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet10Problem2:120}
\begin{aligned}
\ln n
