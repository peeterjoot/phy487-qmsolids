...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture8:20}
w_q = \sqrt{ \frac{ 4 k }{m } } \Abs{ \sin \frac{ q a }{ 2 } }
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture8:40}
q = \frac{2 \pi n}{L}.
\end{equation}
\end{subequations}
%
...
%
\begin{equation}\label{eqn:condensedMatterLecture8:380}
u_{n \alpha i}.
\end{equation}
%
...
%
\begin{equation}\label{eqn:condensedMatterLecture8:400}
...
\end{equation}
where \( r_{n \alpha i} \) is the equilibrium position and \( u_{n \alpha i} \) is the displacement.  This can be written as
%
\begin{equation}\label{eqn:condensedMatterLecture8:400a}
\Phi( r_{n \alpha i} + u_{n \alpha i} ) =
\Phi(r_{n \alpha i})
+ \inv{2}
...
%
\begin{equation}\label{eqn:condensedMatterLecture8:60}
\Phi = \inv{2} k u_{ix}^2 + \inv{2} k u_{ix}^2 =.
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterLecture8:80}
I^{nx}_{nx} = 2 k.
\end{equation}
%
}
...
%
From this generalized quadratic potential, we form the Lagrangian
%
\begin{equation}\label{eqn:condensedMatterLecture8:500}
...
%
\begin{equation}\label{eqn:condensedMatterLecture8:520}
...
%
\begin{equation}\label{eqn:condensedMatterLecture8:120}
M_\alpha \ddot{u}_{n \alpha i} + \sum_{m \beta j} \Phi^{m \beta j}_{n \alpha i} u_{m \beta j} = 0.
\end{equation}
%
For example,
%
\begin{equation}\label{eqn:condensedMatterLecture8:140}
m \ddot{u}_j =
k( u_{j + 1} - u_j )
+ k( u_{j-1} - u_j ).
\end{equation}
...
%
\begin{equation}\label{eqn:condensedMatterLecture8:160}
...
%
\begin{equation}\label{eqn:condensedMatterLecture8:180}
...
or
%
\begin{equation}\label{eqn:condensedMatterLecture8:200}
-\omega_q^2 u_{\alpha i}(q) + \sum_{\beta j} D^{\beta j}_{\alpha i} u_{\beta j}(q) = 0.
\end{equation}
%
We want to solve
%
\begin{equation}\label{eqn:condensedMatterLecture8:220}
\det\lr{
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture8:540}
\Phi_{n, 1}
=
\frac{f}{2} \lr{ u_{n, 1} - u_{n-1, 2} }^2
+ \frac{f}{2} \lr{ u_{n, 2} - u_{n, 1} }^2
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture8:560}
\Phi_{n, 2}
=
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture8:580}
\PD{u_{n, 1}}
{\Phi_{n, 1}}
=
f \lr{ 2 u_{n, 1} - u_{n-1, 2} - u_{n, 2} }
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture8:600}
\PD{u_{n, 2}}
{\Phi_{n, 2}}
=
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture8:240}
M_1 \ddot{u}_{n, 1} + \Phi^{n - 1, 2}_{n, 1} u_{n - 1, 2} + \Phi^{n, 1}_{n, 1} u_{n, 1} + \Phi^{n, 2}_{n, 1} u_{n, 2} = 0
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture8:260}
...
\begin{equation}\label{eqn:condensedMatterLecture8:280}
M_1 \ddot{u}_{n, 1} + f\lr{ 2 u_{n, 1} - u_{n - 1, 2} - u_{n, 2}} = 0
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture8:300}
...
%
\begin{equation}\label{eqn:condensedMatterLecture8:360}
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture8:420}
\lr{ \frac{2 f}{M_1} - \omega_q^2 } u_1(q) - \frac{f}{\sqrt{M_1 M_2}} \lr{ 1 + e^{-i q a} } u_2(q) = 0
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture8:440}
...
%
\begin{equation}\label{eqn:condensedMatterLecture8:460}
\begin{vmatrix}
...
%
\begin{equation}\label{eqn:condensedMatterLecture8:480}
