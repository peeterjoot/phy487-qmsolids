...
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:40}
\begin{aligned}
\Br &= (\Bb + \Ba)/2 \\
\Bs &= (\Bb - \Ba)/2.
\end{aligned}
...
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:20}
\begin{aligned}
m \ddot{\Bu}_\Bn
=
...
%
\begin{subequations}
\begin{equation}\label{eqn:oneAtomBasisPhonon:340}
\begin{aligned}
S_1 &= \sin^2
\lr{ \Ba \cdot \Bq/2 } \\
S_2 &= \sin^2
...
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:140}
A =
\begin{bmatrix}
a & b \\
c & d
...
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:160}
\begin{aligned}
0 &=
\begin{vmatrix}
\lambda - a & - b \\
...
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:180}
\omega^2 =
\inv{2}
...
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:480}
\begin{aligned}
\lr{Tr A}^2
- 4 \Abs{A}
&=
...
%
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:360}
\begin{aligned}
S_1 &= \sin^2
\lr{ \Ba \cdot \Bq } \\
S_2 &= \sin^2
...
Our matrix is
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:460}
A =
\frac{2}{m}
\begin{bmatrix}
...
%
\begin{subequations}
\begin{equation}\label{eqn:oneAtomBasisPhonon:520}
%\begin{aligned}
\omega^2 %&
=
\frac{2}{m}
\lr{ 
   \sum_i K_i S_i 
%\\ & \qquad     
   \pm \sqrt{ (K_2 S_2 - K_1 S_1)^2 + (K_3 S_3 - K_4 S_4)^2 } 
}
%\end{aligned}
\end{equation}
\begin{equation}\label{eqn:oneAtomBasisPhonon:540}
\Bepsilon \propto
\begin{bmatrix}
K_3 S_3 - K_4 S_4 \\
...
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:920}
\Bepsilon \propto
\begin{bmatrix}
...
%
\begin{subequations}
\begin{equation}\label{eqn:oneAtomBasisPhonon:560}
\omega^2 =
\frac{2}{m}
\lr{ K_1 (S_1 + S_2) + K_3(S_3 + S_4) \pm \sqrt{ K_1^2 (S_2 - S_1)^2 + K_3^2 (S_3 - S_4)^2 } }
\end{equation}
\begin{equation}\label{eqn:oneAtomBasisPhonon:580}
\Bepsilon \propto
\begin{bmatrix}
K_3
\lr{ S_3 - S_4 } \\
...
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:940}
\pm ( a (q_x + q_y) /2 ) = a (q_y - q_y) /2 + 2 \pi n.
\end{equation}
%
That is, one of
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:960}
\begin{aligned}
q_x &= \frac{2 \pi}{a} n \\
q_y &= \frac{2 \pi}{a} n
\end{aligned}
...
\begin{equation}\label{eqn:oneAtomBasisPhonon:820}
\begin{aligned}
S_1 &= \sin^2
...
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:840}
A =
\frac{2}{m}
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:880}
\Bepsilon \propto
\begin{bmatrix}
K_2 S_2
-
...
or, equivalently
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:881}
\Bepsilon \propto
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:900}
\Bepsilon \propto
\begin{bmatrix}
K_1 (S_2 - S_1 ) \\
K_3
...
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:980}
\pm \frac{a}{\sqrt{2}} (k_u - k_v) = \frac{a}{\sqrt{2}} (k_u + k_v) + 2 \pi n,
\end{equation}
%
or one of
%
\begin{equation}\label{eqn:oneAtomBasisPhonon:1000}
\begin{aligned}
