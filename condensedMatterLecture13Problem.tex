...
%
\makeproblem{Thomas-Fermi screening length.}{pr:condensedMatterLecture13:1}{
...
%
\begin{equation}\label{eqn:condensedMatterLecture13P1:560}
\inv{r^2} \frac{d}{dr} \lr{ r^2 \frac{df}{dr} } = a f.
\end{equation}
%
We can make this more tractable with a substitution
%
\begin{equation}\label{eqn:condensedMatterLecture13P1:580}
g = r f,
\end{equation}
%
for which we have
\begin{equation}\label{eqn:condensedMatterLecture13P1:600}
...
%
\begin{equation}\label{eqn:condensedMatterLecture13P1:640}
\begin{aligned}
\frac{d}{dr} \lr{
...
or just
%
\begin{equation}\label{eqn:condensedMatterLecture13P1:660}
\frac{d^2 g}{dr^2} = a g.
\end{equation}
%
This has the solution
%
\begin{equation}\label{eqn:condensedMatterLecture13P1:680}
g = \sum_{\pm} A_{\pm} e^{\pm \sqrt{a} r},
\end{equation}
%
Picking the non-hyperbolic solution, that is
%
\begin{equation}\label{eqn:condensedMatterLecture13P1:700}
