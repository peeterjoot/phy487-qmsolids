...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:20}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:40}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:60}
V(x) =
\sum_{-\infty}^\infty
V_\nought \delta(x - n a).
\end{equation}
...
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:80}
\psi_k(x) =
\inv{\sqrt{a}}
e^{i k x},
\end{equation}
...
%
\item On this branch, the wave function is
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:100}
\begin{aligned}
\psi_k(x)
&= \inv{\sqrt{a}}
e^{i \lr{k - 2 \pi/a} x}
...
%
\item On this branch, the wave function is
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:400}
\begin{aligned}
\psi_k(x)
&= \inv{\sqrt{a}}
e^{i \lr{k + 2 \pi/a} x}
...
%
\item On this branch, the wave function is
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:200}
\begin{aligned}
\psi_k(x)
&= \inv{\sqrt{a}}
e^{i \lr{k - 4 \pi/a} x}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:240}
V(x) =
\frac{V_1}{2} \lr{
e^{ i G x }
+ e^{ -i G x }
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:280}
\begin{aligned}
0 
&=
\lr{ \frac{\Hbar^2}{2m} \lr{k - n G}^2 - E } C_{k - n G} \\
&\quad + V_G \lr{ C_{ k - (1 + n) G } + C_{ k + (1 - n) G } }
...
%\end{dmath}
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:440}
0 =
\begin{bmatrix}
                  {E_{k -2 G}^\nought} - E & V_G         & V_{2G}   & 0                & 0            \\
                  V_{G}        & {E_{k - G}^\nought} - E & V_G      & V_{2G}           & 0            \\
...
%
or
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:320}
0 =
\begin{vmatrix}
                  {E_{k -2 G}^\nought} - E & V_G         & V_{2G}   & 0                & 0            \\
                  V_{G}        & {E_{k - G}^\nought} - E & V_G      & V_{2G}           & 0            \\
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:340a}
0 =
\begin{bmatrix}
                                 {E_{k -G}^\nought} - E & V_G      \\
                                 V_{G}       & {E_{k }^\nought} - E
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:340}
0 =
\begin{vmatrix}
                                 {E_{k}^\nought} - E & V_G      \\
                                 V_{G}       & {E_{k }^\nought} - E
...
or
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:360}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:460}
0 =
\begin{bmatrix}
                                 {E_{k -G}^\nought} - E & V_{2G}      \\
                                 V_{2G}       & {E_{k +G}^\nought} - E
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:480}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1200}
0 =
\begin{bmatrix}
                  {E_{k -2 G}^\nought} - E & 0 \\
                  0            & {E_{k + G }^\nought} - E \\
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1220}
E_{\pm} = {E_{k + G}^\nought}.
\end{equation}
%
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:560}
\begin{aligned}
C_{G_{h}}
&=
\int_{-1/2}^{1/2} du V( u a ) e^{i h G a u}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:580}
V(x) = \frac{V_\nought}{a} \sum_h e^{i G_h x}.
\end{equation}
%
Schr\"{o}dinger's equation for this potential is
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:600}
...
% k' = k - G
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:620}
0 = \lr{ \hkSq{k} - E } C_{k} + \frac{V_\nought}{a} \sum_G C_{k - G}.
\end{equation}
%
Noting that
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:640}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:660}
C_k
=
...
and
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:680}
\cancel{\sum_k C_k }
=
...
or
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:700}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:720}
\sqrt{E} =
\frac{V_\nought}{a}
\frac{2 \pi  m}{ \Hbar^2 }
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:800}
0 \approx
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:740}
0 \approx
\begin{vmatrix}
\frac{V_\nought}{a} + {E_{k}^\nought} - E & \frac{V_\nought}{a} \\
\frac{V_\nought}{a} & \frac{V_\nought}{a} + {E_{k}^\nought} - E
...
%
or
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:760}
E_\pm \approx
{E_{k}^\nought} - \frac{V_\nought}{a}
\pm \Abs{ \frac{V_\nought}{a} }.
\end{equation}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:820}
C_{k - G}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:840}
\psi_{\pm} \propto
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:860}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:940}
E_{\pm} =
\inv{2}
\lr{
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:960}
C_{k - G}
\inv{2}
\lr{
...
This gives
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:980}
\psi_{k,\pm}(x)
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1000}
\begin{aligned}
E_{k -G}^\nought - E_{k }^\nought
&= \hkSq{\lr{k- G}}
- \hkSq{k}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1040}
\epsilon_\pm(k) =
\lr{
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1060}
\psi_{k,\pm}(x)
=
\lr{
-V_1
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1080}
\rho_{k,\pm}(x)
=
\Abs{
-V_1
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1100}
\begin{aligned}
\epsilon_{-}(k)
&=
\lr{
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1120}
k = \frac{\pi}{a}( 1 - \alpha ),
\end{equation}
%
we have
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1240}
\begin{aligned}
\epsilon_{-}(k)
&=
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1140}
\begin{aligned}
\rho_{k,-}(x)
&=
\Abs{
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1160}
\frac{h^2 \lr{ 1 - \frac{k a}{\pi}} }{2m a^2} \gg V_1^2,
\end{equation}
%
we have
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1180}
\epsilon_{-}(k)
\approx
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet7Problem2:1260}
\begin{aligned}
\rho_{k,\pm}(x)
&\approx
\Abs{
