...
Assume a periodic lattice with large lattice parameter \(a\), so that atomic potential \(V_a(\Br - \Br_n)\) and wave functions \(\phi(\Br- \Br_n)\) don't overlap much between neighbors, as sketched in \cref{fig:qmSolidsL16:qmSolidsL16Fig1}.  The potential \(\phi_i(\Br - \Br_n)\) satisfies
%
\imageFigure{../figures/phy487-qmsolids/qmSolidsL16Fig1}{Tight binding lattice.}{fig:qmSolidsL16:qmSolidsL16Fig1}{0.3}
%
\begin{equation}\label{eqn:condensedMatterLecture16:20}
\hat{H}_A \phi_i(\Br - \Br_n) = E_i \phi(\Br - \Br_n).
\end{equation}
%
where
%
\begin{equation}\label{eqn:condensedMatterLecture16:40}
\hat{H}_A = - \frac{\Hbar}{2m} \spacegrad + V_A(\Br - \Br_n).
\end{equation}
%
The one electron Hamiltonian
%
\begin{equation}\label{eqn:condensedMatterLecture16:60}
\begin{aligned}
\hat{H}
...
%
\begin{equation}\label{eqn:condensedMatterLecture16:80}
\begin{aligned}
...
%
\begin{equation}\label{eqn:condensedMatterLecture16:100}
\Phi_\Bk(\Br) = U_\Bk e^{i \Bk \cdot \Br},
\end{equation}
%
implies
%
\begin{equation}\label{eqn:condensedMatterLecture16:120}
\Phi_\Bk(\Br +\Br_m) = \Phi_\Bk(\Br) e^{i \Bk \cdot \Br_m},
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterLecture16:140}
\begin{aligned}
\Phi_\Bk(\Br +\Br_m)
&=
\sum_n
...
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterLecture16:160}
...
Calculate
%
\begin{equation}\label{eqn:condensedMatterLecture16:340}
E(\Bk) =
\frac{
	\bra{
	\Phi_\Bk}
...
With
%
\begin{equation}\label{eqn:condensedMatterLecture16:180}
\begin{aligned}
\braket{\Phi_\Bk}{\Phi_\Bk}
&=
...
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterLecture16:200}
\begin{aligned}
E(\Bk) &\approx \inv{N}
\sum_{n, m} e^{i \Bk \cdot (\Br_n - \Br_m)}
\int d\Br
...
%
\begin{equation}\label{eqn:condensedMatterLecture16:220}
\begin{aligned}
- A &=
\int d\Br
\phi_i^\conj( \Br - \Br_n)
...
So
%
\begin{equation}\label{eqn:condensedMatterLecture16:240}
E(\Bk) \approx \inv{N}
\lr{
...
or
%
\begin{equation}\label{eqn:condensedMatterLecture16:260}
...
For 1D we have
%
\begin{equation}\label{eqn:condensedMatterLecture16:280}
\Br_n - \Br_m = \pm a,
\end{equation}
%
which implies the nearest neighbor sum is
%
\begin{equation}\label{eqn:condensedMatterLecture16:300}
\sum_{nn} \lr{
e^{i k a}
+e^{-i k a}
}
...
So
%
\begin{equation}\label{eqn:condensedMatterLecture16:320}
E(k) \approx E_i - A -
\mathLabelBox
{2 B \cos k a
}
