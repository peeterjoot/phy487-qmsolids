...
%
\begin{equation}\label{eqn:condensedMatterLecture10:20}
P_n =
\frac
{ e^{-E_n/\kB T} }
...
%
\begin{equation}\label{eqn:condensedMatterLecture10:40}
Z = \sum_{n = 0}^\infty e^{-E_n/\kB T},
\end{equation}
%
is a normalization sum so that
%
\begin{equation}\label{eqn:condensedMatterLecture10:60}
\sum_{n = 0}^\infty P_n = 1.
\end{equation}
%
For the harmonic oscillator, we have
%
\begin{equation}\label{eqn:condensedMatterLecture10:80}
E_n = \lr{ n + \inv{2} } \Hbar \omega,
\end{equation}
%
so that
\begin{equation}\label{eqn:condensedMatterLecture10:100}
\begin{aligned}
Z
...
%
\begin{equation}\label{eqn:condensedMatterLecture10:120}
\begin{aligned}
\calE(\omega_q T)
&= \expectation{ E_n } \\
&= \sum_n E_n P_n \\
...
Here
%
\begin{equation}\label{eqn:condensedMatterLecture10:440}
\inv{
...
%
\begin{equation}\label{eqn:condensedMatterLecture10:160}
\begin{aligned}
\calE(\omega_q T)
&\approx
...
%
\begin{equation}\label{eqn:condensedMatterLecture10:180}
\calE(\omega_q T)
\approx
...
\end{itemize}
%
\begin{equation}\label{eqn:condensedMatterLecture10:200}
\CV(T) = \PDc{T}{U}{V}.
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterLecture10:220}
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture10:460}
Z(\omega) d\omega
=
\frac{V}{2\pi^2}
\lr{
...
\omega^2 d \omega,
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture10:500}
...
%
\begin{equation}\label{eqn:condensedMatterLecture10:240}
\begin{aligned}
\CV(T)
&=
\frac{d}{dT}
...
%
\begin{equation}\label{eqn:condensedMatterLecture10:480}
\begin{aligned}
\CV(T)
&=
\frac{ 9 r N}{V}
...
so that
%
\begin{equation}\label{eqn:condensedMatterLecture10:260}
...
%
\begin{equation}\label{eqn:condensedMatterLecture10:280}
\begin{aligned}
\CV(T) 
&=
\lr{
...
Make substitutions
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture10:300}
y = \frac{\Hbar \omega}{\kB T}
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture10:320}
d\omega = \frac{\kB T}{\Hbar} dy
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture10:340}
...
%
\begin{equation}\label{eqn:condensedMatterLecture10:520}
y(\omega_{\txtD}) = \frac{\Hbar \omega_{\txtD}}{ \kB T} = \frac{\kB \Theta}{\kB T} = \frac{\Theta}{T},
\end{equation}
%
so the specific heat is
%
\begin{equation}\label{eqn:condensedMatterLecture10:360}
\begin{aligned}
\CV(T)
&=
\lr{ \frac{ 9 r N }{V} \inv{\omega_{\txtD}^3} }
...
%
\begin{equation}\label{eqn:condensedMatterLecture10:380}
...
%
\begin{equation}\label{eqn:condensedMatterLecture10:400}
\begin{aligned}
\CV(T)
&=
\frac{ 9 r N }{V}
...
%
\begin{equation}\label{eqn:condensedMatterLecture10:420}
\begin{aligned}
U(T) &\sim T^4 \\
C(T) &= T^3.
\end{aligned}
