...
%
\begin{equation}\label{eqn:condensedMatterLecture12:20}
...
%
\begin{equation}\label{eqn:condensedMatterLecture12:40}
\begin{aligned}
g_r&(U - \epsilon, N - n)
=
...
%
\begin{equation}\label{eqn:condensedMatterLecture12:60}
S_r = \kB \ln g_r,
\end{equation}
%
we have (approximately)
%
\begin{equation}\label{eqn:condensedMatterLecture12:80}
P(\epsilon, n) \propto
\exp\lr{
\ln g_r(U, N)
...
%
\begin{equation}\label{eqn:condensedMatterLecture12:100}
\begin{aligned}
dU_r
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture12:360}
...
+ \mu dN_r \wedge dU_r
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture12:380}
dU_r \wedge dN_r
= T
\lr{
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture12:120}
\PDc{U_r}{S_r}{P,V} = \inv{T}
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture12:140}
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture12:200}
P(\epsilon = 0, n = 0) = \inv{ 1 + e^{-(\epsilon_i - \mu)}}
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture12:220}
...
Average occupancy
%
\begin{equation}\label{eqn:condensedMatterLecture12:240}
...
%
\begin{equation}\label{eqn:condensedMatterLecture12:280}
...
so that
%
\begin{equation}\label{eqn:condensedMatterLecture12:300}
...
Estimate
%
\begin{equation}\label{eqn:condensedMatterLecture12:320}
U(T) - U(0)
\sim
\mathLabelBox
...
%
\begin{equation}\label{eqn:condensedMatterLecture12:340}
\begin{aligned}
C(T)
&= \frac{dU}{dT}
\\ &\sim 2 \kB^2 D(\EF) T
...
%
\begin{equation}\label{eqn:condensedMatterLecture12:400}
\begin{aligned}
\sqrt{\EF}
&= \frac{\EF^{3/2}}{\EF}
\\ &=
...
%
so that
\begin{equation}\label{eqn:condensedMatterLecture12:420}
\begin{aligned}
C(T)
