...
\end{dmath}
%
The nearest neighbour differences are illustrated in \cref{fig:qmSolidsPs8a:qmSolidsPs8aFig1}, which we see are
%
\imageFigure{../figures/phy487-qmsolids/qmSolidsPs8aFig1}{Cubic nearest neighbour differences.}{fig:qmSolidsPs8a:qmSolidsPs8aFig1}{0.2}
%
