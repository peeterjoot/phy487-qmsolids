...
%
\makeoproblem{Debye calculation in 2D.}{condensedMatter:problemSet5:3}{2013 ps5 p3}{
...
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:20}
\begin{aligned}
2 \pi n_x &= L_x q_x \\
2 \pi n_y &= L_y q_y,
\end{aligned}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:40}
\begin{aligned}
\sum_\Bn
&\approx
\int dn_x dn_y
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:60}
\omega =
\left\{
\begin{array}{l l}
...
This gives
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:80}
\begin{aligned}
\int Z(\omega) d\omega
&=
...
%
or
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:160}
Z(\omega) =
\frac{A}{2\pi}
\lr{
\frac{1}{C_{\txtL}^2} + \frac{1}{C_{\txtT}^2}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:100}
\int_0^{\omega_{\txtD}} Z(\omega) d\omega = 2 r N.
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:120}
\begin{aligned}
2 r N
&=
...
or
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:140}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:180}
Z(\omega) =
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:200}
\begin{aligned}
\cA(T)
&=
\frac{dU}{dT}
...
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:220}
y = \frac{\Hbar \omega}{\kB T}
\end{equation}
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:240}
d\omega = \frac{\kB T}{\Hbar} dy
\end{equation}
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:280}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:300}
\begin{aligned}
\cA(T)
&=
\frac{4 r N }{ A \omega_{\txtD}^2 }
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem3:320}
