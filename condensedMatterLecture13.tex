...
%
\begin{equation}\label{eqn:condensedMatterLecture13:20}
...
%
\begin{equation}\label{eqn:condensedMatterLecture13:40}
f(E, T) = \inv{ e^{(E - \mu)/\kB T} + 1},
\end{equation}
%
we calculated an approximate value for the specific heat
%
\begin{equation}\label{eqn:condensedMatterLecture13:60}
C(T) \sim 2 \kB D(\EF) T.
\end{equation}
%
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture13:80}
U(T) = \int dE D(E) E f(E, T)
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture13:100}
C(T) = \PD{T}{U},
\end{equation}
\end{subequations}
%
...
%
\begin{equation}\label{eqn:condensedMatterLecture13:120}
...
%
\begin{equation}\label{eqn:condensedMatterLecture13:140}
\begin{aligned}
\PD{T}{f(E, T)}
&=
-
...
%
\mathImageFigure{../figures/phy487-qmsolids/fermiDiracLevelCurvesAndDerivativesFig3}{Fermi-Dirac distribution and derivatives.}{fig:fermiDiracLevelCurvesAndDerivatives:fermiDiracLevelCurvesAndDerivativesFig3}{0.2}{fermiDiracPlot.nb}

The expected value of the number density is
%
\begin{equation}\label{eqn:condensedMatterLecture13:160}
n = \int dE D(E) f(E, T).
\end{equation}
%
It's derivative with respect to temperature is
%
\begin{equation}\label{eqn:condensedMatterLecture13:180}
\PD{T}{n} = \int dE D(E) \PD{T}{f}.
\end{equation}
%
With a constant constraint on the number of states, this derivative is zero, allowing us to write
%
\begin{equation}\label{eqn:condensedMatterLecture13:200}
\begin{aligned}
C(T)
&=
C(T) - \EF \PD{T}{n} \\
...
%
\begin{equation}\label{eqn:condensedMatterLecture13:220}
\int_0^\infty \rightarrow \int_{-\infty}^\infty,
\end{equation}
%
To proceed with the integration, let
%
\begin{equation}\label{eqn:condensedMatterLecture13:240}
x = \frac{E - \EF}{\kB T}.
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterLecture13:260}
\begin{aligned}
C(T) &\approx
D(\EF)
\int_{-\infty}^\infty
...
%
\begin{equation}\label{eqn:condensedMatterLecture13:320}
U(T) \sim T^2 
\implies 
C(T) \propto T
\end{equation}
...
%
\begin{equation}\label{eqn:condensedMatterLecture13:300}
...
%
\begin{equation}\label{eqn:condensedMatterLecture13:340}
\spacegrad^2 \phi(\Br) = - \frac{\rho(\Br)}{\epsilon_\nought}.
\end{equation}
%
Split the charge density as
%
\begin{equation}\label{eqn:condensedMatterLecture13:360}
\rho(\Br) =
...
\end{equation}
where \(
   \overbar{\rho}_{\mathrm{el}} \) is the average electron density, 
\(
   \overbar{\rho}_{\mathrm{ion}} \) is the positive background, and \(
\delta \rho_{\mathrm{el}} \) is the perturbation to \( Q\).
...
%
\begin{equation}\label{eqn:condensedMatterLecture13:380}
\begin{aligned}
\rho_{\mathrm{el}}
&= -e
\int dE D(E)
...
%
\begin{equation}\label{eqn:condensedMatterLecture13:400}
\int_{\EF - \Delta}
^{\EF + \Delta}
dE \PD{E}{f}
= -1,
...
, so we can write
%
\mathImageFigure{../figures/phy487-qmsolids/fermiDiracLevelCurvesAndEnergyDerivativesFig4}{Delta function like region.}{fig:fermiDiracLevelCurvesAndEnergyDerivatives:fermiDiracLevelCurvesAndEnergyDerivativesFig4}{0.2}{fermiDiracPlot.nb}
%\imageFigure{../figures/phy487-qmsolids/qmSolidsL13Fig8}{Delta function like region}{fig:qmSolidsL13:qmSolidsL13Fig8}{0.2}
%
\begin{equation}\label{eqn:condensedMatterLecture13:420}
\begin{aligned}
\rho_{\mathrm{el}}
&\approx
\overbar{\rho}_{\mathrm{el}}
...
\begin{equation}\label{eqn:condensedMatterLecture13:520}
r_{\mathrm{TF} }
\sim
0.5
\angstrom.
