...
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem1:20}
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem1:40}
\int_{x^2 + y^2 + z^2 \le q^2} dx dy dz = \frac{4}{3} \pi q^3
\end{equation}
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem1:60}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem1:80}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem1:100}
\begin{aligned}
\sum_n
\sim \int dn
&= \frac{L}{2 \pi} \int dq
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem1:120}
Z(\omega) = \frac{L}{2 \pi} \frac{dq}{d\omega}.
\end{equation}
%
Now we are ready to start.  For the 1D chain we had
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem1:140}
\sqrt{\frac{M}{K}} \omega(q) = 2 \sin \lr{ \frac{ q a}{2} },
\end{equation}
%
so
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem1:160}
\sqrt{\frac{M}{K}} = a \cos \lr{ \frac{ q a}{2} } \frac{dq}{d\omega},
\end{equation}
%
or
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem1:180}
\begin{aligned}
Z(\omega)
&= \frac{L}{2 \pi}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem1:220}
\begin{aligned}
Z(\omega \approx 0)
&=
\inv{2} \sqrt{\frac{M}{K}} \frac{N}{\pi}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet5Problem1:240}
\begin{aligned}
