...
%
\begin{equation}\label{eqn:condensedMatterLecture5:20}
A_p(\Br, t) =
A_\nought
\exp\lr{ i \lr{
k_\nought
...
%
\begin{equation}\label{eqn:condensedMatterLecture5:120}
\rho(\Br) A_p(\Br, t).
\end{equation}
%
where
%
\begin{equation}\label{eqn:condensedMatterLecture5:40}
\rho(\Br) = \text{``scattering density''}.
\end{equation}
%
For neutrons we've got interactions with the nuclei, and things get messier, but for x-rays
%
\begin{equation}\label{eqn:condensedMatterLecture5:60}
...
%
\begin{equation}\label{eqn:condensedMatterLecture5:80}
\begin{aligned}
...
%
\begin{equation}\label{eqn:condensedMatterLecture5:100}
\Abs{\Bk} = \Abs{\Bk_\nought} = \frac{\omega_\nought}{c}.
\end{equation}
%
...
%
\begin{equation}\label{eqn:condensedMatterLecture5:140}
A_B(\Br) \approx
\mathLabelBox
[
...
%
\begin{equation}\label{eqn:condensedMatterLecture5:160}
...
%
\begin{equation}\label{eqn:condensedMatterLecture5:180}
...
%
\begin{equation}\label{eqn:condensedMatterLecture5:200}
\rho(x) = \sum_n p_n e^{ i n 2 \pi x/a }.
\end{equation}
%
Show that
%
\begin{equation}\label{eqn:condensedMatterLecture5:220}
\rho(x + m a) = \rho(x).
\end{equation}
%
- 3D lattice
%
\begin{equation}\label{eqn:condensedMatterLecture5:240}
\rho(\Br) = \sum_\BG \rho_\BG e^{ i \BG \cdot \Br }.
\end{equation}
%
With
%
\begin{equation}\label{eqn:condensedMatterLecture5:260}
\Br_n =
n_1 \Ba_1 +
n_2 \Ba_2 +
n_3 \Ba_3,
...
%
\begin{equation}\label{eqn:condensedMatterLecture5:280}
\rho(\Br + \Br_n) = \rho(\Br).
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterLecture5:300}
e^{ i \BG \cdot \Br_n } = 1,
\end{equation}
%
or
\begin{equation}\label{eqn:condensedMatterLecture5:320}
\BG \cdot \Br_n = 2 \pi m,
\end{equation}
%
...
Try
%
\begin{equation}\label{eqn:condensedMatterLecture5:340}
\BG =
h \Bg_1 +
k \Bg_2 +
l \Bg_3,
...
%
\begin{equation}\label{eqn:condensedMatterLecture5:440}
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture5:460}
\Bg_1 = 2 \pi
\frac
{ \Ba_2 \cross \Ba_3 }
{ \Ba_1 \cdot \lr{ \Ba_2 \cross \Ba_3} }
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture5:460b}
\Bg_2 = 2 \pi
\frac
{ \Ba_3 \cross \Ba_2 }
{ \Ba_2 \cdot \lr{ \Ba_3 \cross \Ba_1} }
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture5:460c}
\Bg_3 = 2 \pi
\frac
{ \Ba_1 \cross \Ba_3 }
