...
%
\begin{equation}\label{eqn:condensedMatterLecture15:20}
V(\Br) = \sum_\BG V_\BG e^{i \BG \cdot \Br},
\end{equation}
%
and a trial solution
\begin{equation}\label{eqn:condensedMatterLecture15:n}
\Psi(\Br) = \sum_\Bk C_\Bk e^{i \Bk \cdot \Br },
\end{equation}
%
we found that the Schr\"{o}dinger equation takes the form
%
\begin{equation}\label{eqn:condensedMatterLecture15:40}
...
%
\begin{equation}\label{eqn:condensedMatterLecture15:60}
\Psi_\Bk(\Br) = \lr{
\sum_\BG
C_{\Bk - \BG}
e^{i \BG \cdot \Br}
...
%
\begin{equation}\label{eqn:condensedMatterLecture15:80}
...
%
\begin{equation}\label{eqn:condensedMatterLecture15:100}
C_{\Bk - \BG}
=
\frac{
...
%
\begin{equation}\label{eqn:condensedMatterLecture15:120}
E(\Bk) \approx
\frac{\Hbar^2 \lr{\Bk -\BG}^2}{2m}.
\end{equation}
%
...
%
\begin{equation}\label{eqn:condensedMatterLecture15:140}
E(\Bk) \approx
\frac{ \Hbar^2 \Bk^2 }{2m}.
\end{equation}
%
...
At (2) we have
%
\begin{equation}\label{eqn:condensedMatterLecture15:160}
E(\Bk) \approx
...
%
\begin{equation}\label{eqn:condensedMatterLecture15:180}
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture15:200}
C_{\Bk}
=
\frac{
\sum_{\BG''} V_{\BG'' - \BG} C_{\Bk - \BG''}
...
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture15:220}
C_{\Bk - \BG}
=
\frac{
\sum_{\BG''} V_{\BG'' - \BG} C_{\Bk - \BG''}
...
%
\begin{equation}\label{eqn:condensedMatterLecture15:240}
\begin{aligned}
...
With solution
%
\begin{equation}\label{eqn:condensedMatterLecture15:260}
0 =
\begin{vmatrix}
\lr{
\frac{\Hbar^2 k^2}{2m}
...
%
\begin{equation}\label{eqn:condensedMatterLecture15example2cKs:261}
\begin{aligned}
0 
&=
\lr{
...
or
%
\begin{equation}\label{eqn:condensedMatterLecture15:280}
E^{\pm}(k) =
\inv{2} \lr{ E_k^\nought + E_{k - 2\pi/a}^\nought }
\pm
\sqrt{
...
\mathImageFigure{../figures/phy487-qmsolids/qmSolidsWeakBindingNearBraggFig1}{Weak binding plot with behavior near Bragg plane.}{fig:qmSolidsWeakBindingNearBragg:qmSolidsWeakBindingNearBraggFig1}{0.3}{weakBindingPotentialNearBraggPlane.nb}
At the crossing point \(k = \pi/a\), and \(k - 2 \pi/a = -\pi/a\), so that
%
\begin{equation}\label{eqn:condensedMatterLecture15:300}
E^{\pm} = \frac{\Hbar^2}{2m} \lr{ \frac{\pi}{a} }^2 \pm \Abs{V_{2 \pi/a}},
\end{equation}
%
or more generally
%
\begin{equation}\label{eqn:condensedMatterLecture15:320}
...
%
\begin{equation}\label{eqn:condensedMatterLecture15:340}
\Psi_{k = \pi/a} =
...
%or
%
\begin{equation}\label{eqn:condensedMatterLecture15:360}
...
%
\begin{equation}\label{eqn:condensedMatterLecture15:380}
\begin{aligned}
\cos\frac{\pi}{a} x \\
\sin\frac{\pi}{a} x
\end{aligned}
