...
%
\makeoproblem{1D chain, two spring constants.}{condensedMatter:problemSet4:2}{2013 ps4 p2}{
...
\imageFigure{../figures/phy487-qmsolids/two_springsFig1}{Two springs chain.}{fig:two_springs:two_springsFig1}{0.08}
%
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet4Problem2:20}
\begin{aligned}
\LL &= \sum_{n, \alpha} \frac{m}{2} \dot{u}_{n, \alpha}^2 
- \frac{k'}{2}\lr{ u_{n, 1} - u_{n - 1, 2}}^2 \\
&\qquad- \frac{k}{2}\lr{ u_{n, 2} - u_{n, 1}}^2
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet4Problem2:40}
...
which gives us
%
\begin{equation}\label{eqn:condensedMatterProblemSet4Problem2:300}
\begin{aligned}
0 
&= -m \omega^2
...
%%%
%%%\begin{equation}\label{eqn:condensedMatterProblemSet4Problem2:100}
...
%
or
\begin{equation}\label{eqn:condensedMatterProblemSet4Problem2:280}
\omega^2 =
\frac{2 k_\nought }{m} \lr{ 1
\pm
\sqrt{
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet4Problem2:440}
\begin{aligned}
2 k_\nought u_1
&=
\lr{
...
%
%\begin{equation}\label{eqn:condensedMatterProblemSet4Problem2:520}
%q a N = 2 \pi m,.
%\end{equation}
%
%or
%
%\begin{equation}\label{eqn:condensedMatterProblemSet4Problem2:540}
%q a = \frac{2 \pi m}{N},.
%\end{equation}
%
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet4Problem2:640}
\begin{aligned}
-m \omega_\nought^2 u_1
&=
(k_\nought + \delta)
...
so that
%
\begin{equation}\label{eqn:condensedMatterProblemSet4Problem2:760}
\begin{aligned}
\omega^2
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet4Problem2:780}
\begin{aligned}
\omega
&\approx
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet4Problem2:880}
\omega \in \left\{
2 \omega_\nought \cos \frac{qa}{4},
2 \omega_\nought \sin \frac{qa}{4}
 \right\}.
