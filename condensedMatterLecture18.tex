...
The lower energy curves correspond to bonding orbitals.  In general in materials the bonding orbitals will always be occupied, because they are energy favourable.
}
...
Recall
%
\begin{equation}\label{eqn:condensedMatterLecture18:20}
\begin{aligned}
\sum_{k, \sigma = \pm 1/2}
&\rightarrow
\mathLabelBox{2}{spin}
...
%
\begin{equation}\label{eqn:condensedMatterLecture18:40}
\begin{aligned}
...
and in general
%
\begin{equation}\label{eqn:condensedMatterLecture18:60}
...
%
\begin{equation}\label{eqn:condensedMatterLecture18:80}
\begin{aligned}
...
%
\begin{equation}\label{eqn:condensedMatterLecture18:100}
C(T) =
\mathLabelBox
{
\gamma T
...
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterLecture18:120}
\begin{aligned}
...
Here we have Van Hove singularities.  Note that max/min at \(\Gamma\) do not produce a \textAndIndex{Van Hove singularity}, because \(d f_{\txtE}\) is vanishingly small.
%
...
\mathImageFigure{../figures/phy487-qmsolids/qmSolidsL18PacketSpreadingFig1}{Packet spreading with time.}{fig:qmSolidsL18:qmSolidsL18Fig7}{0.17}{guassianPlotsL18L19.nb}
