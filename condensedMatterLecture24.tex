...
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:20}
...
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:40}
...
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:60}
V_{\mathrm{eff}} = \frac{
...
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:80}
\ket{\Psi} = \sum_k g(\Bk) e^{ i \Bk \cdot (\Br_1 - \Br_2 ) }.
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:100}
\lr{
-\frac{\Hbar^2}{2m} \lr{
\spacegrad_1^2 +
\spacegrad_2^2
...
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:120}
...
This is
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:140}
2 \bcE_{\Bk'} g(\Bk') + \sum_\Bk V_{\Bk'\Bk} g(\Bk)
= \lr{ 2 \EF + \calE } g(\Bk'),
\end{equation}
%
where
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:160}
V_{\Bk, \Bk'} =
\int d\Br_1 d\Br_2
...
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:180}
V_{\Bk, \Bk'} =
\left\{
\begin{array}{l l}
...
This has solution
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:200}
g(\Bk') = \inv{ 2 \EF + \calE - 2 \calE_{\Bk'}} \sum_\Bk V_{\Bk', \Bk} g(\Bk).
\end{equation}
%
Sum this over \(\Bk'\)
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:220}
\cancel{\sum_{\Bk'} g(\Bk')} = \sum_{\Bk'}
\frac{V_\nought}{ 2 \EF + \calE - 2 \calE_{\Bk'}} \cancel{\sum_\Bk g(\Bk)}.
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:240}
\begin{aligned}
...
Giving
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:260}
e^{ 2/V_\nought D(\EF) } = \frac{\calE - 2 \Hbar \omega_{\txtD}}{\calE}.
\end{equation}
%
or
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:280}
...
BCS guess was:
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:320}
\ket{0_{\mathrm{BCS}}}
=
\Pi_\Bk \lr{
...
The energy
%
\begin{equation}\label{eqn:condensedMatterPhysicsLecture24:340}
W
