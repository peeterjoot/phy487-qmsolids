...
%
\makeoproblem{Density of states and effective mass.}{condensedMatter:problemSet9:2}{2013 ps9 p2}{
The dispersion relation of
a two-dimensional square lattice with lattice parameter \(a\),
with nearest-neighbor tight-binding integrals \(A\) and \(B\), is
%
\begin{eqnarray*}
...
For the three-dimensional cubic system of \partref{condensedMatter:problemSet9:2b}, find the group
  ...
  and sketch its behavior from \(k_x=0\) to \(\pi/a\).
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:20}
\begin{aligned}
E(\Bk)
&\approx E_s - A - 2B \lr{
1 - \inv{2} \lr{ k_x a }^2
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:40}
\begin{aligned}
\spacegrad_\Bk E(\Bk)
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:60}
\begin{aligned}
d \Bk
&= k d\phi_k dk
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:80}
\begin{aligned}
D(E) dE
&=
2 \times \inv{A} \frac{A}{(2 \pi)^2} \times \\
&\qquad \int_{\phi_k = 0}^{2 \pi} \cancel{k} d\phi_k \frac{dE}{2 B a^2 \cancel{k}},
\end{aligned}
\end{equation}
%
or
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:120}
\begin{aligned}
\cos k a
&=
\inv{0!}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:140}
E(\Bk) =
E_s - A + 4 B - B
\lr{
\lr{ k_x a \mp \pi}^2
...
%
with gradient
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:180}
\begin{aligned}
\spacegrad_\Bk E(\Bk)
&=
- 2 B a
...
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:160}
E(\Bk) =
E_s - A + 4 B - B
\lr{
\lr{ k_x a \mp \pi}^2
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:200}
\spacegrad_\Bk E(\Bk)
%=
%- 2 B a
%\lr{
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:220}
\begin{aligned}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:240}
D(E) dE = 2 \times
4
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:360}
\begin{aligned}
E(\Bk) &\approx
E_s - A - 2 B \lr{
3
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:400}
\begin{aligned}
D(E)
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:420}
\begin{aligned}
E(\Bk) &\approx
E_s - A - 2 B \lr{
-3
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:440}
\begin{aligned}
\spacegrad_\Bk E(\Bk)
&=
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:480}
\begin{aligned}
D(E) 
&= 2 \times 8 \times \inv{ (2 \pi)^3 }
\int_0^{\pi/2} \sin \theta_k d\theta_k \times \\
&\qquad \int_0^{\pi/2} d\phi_k
\evalbar
{
\frac{k^2}{ 2 B a^2 k}
}{k = k(E)} \\
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:260}
\begin{aligned}
\Bv_g
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet9Problem2:280}
