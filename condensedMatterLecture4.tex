...
%
\imageFigure{../figures/phy487-qmsolids/qmSolidsL4Fig1}{Lattice geometry.}{fig:qmSolidsL4:qmSolidsL4Fig1}{0.15}
...
%
\imageFigure{../figures/phy487-qmsolids/qmSolidsL4Fig2}{Symmetries of a graphene lattice.}{fig:qmSolidsL4:qmSolidsL4Fig2}{0.2}
...
%
\reading \citep{ashcroft1976solid} \textchapref{4}
...
\textunderline{Simple cubic} \index{simple cubic} Very rare: only \ce{Po}, which is very toxic.  This is in fact the toxic substance that was used as in the assassination by injection in the UK of Alexander Litvinenko, the former KGB and FSB agent turned undesirable reporter for Chechenia \citep{wiki:litvinenkoPo}.

%\cref{fig:simpleCubicPacking:simpleCubicPackingFig1}.
\imageFigure{../figures/phy487-qmsolids/simpleCubicPackingFig1}{Simple cubic.}{fig:simpleCubicPacking:simpleCubicPackingFig1}{0.2}
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture4:20}
\mbox{8 corners \(\times \inv{8}\) = 1 atoms}
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture4:40}
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture4:60}
\Ba =
\lr{
\inv{\sqrt{2}},
\inv{\sqrt{2}},
...
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture4:80}
\Bb =
\lr{
\inv{\sqrt{2}},
0,
...
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture4:100}
\Bc =
\lr{
0,
\inv{\sqrt{2}},
...
%
\begin{equation}\label{eqn:condensedMatterLecture4:120}
\Br_n = n_1 \Ba + n_2 \Bb + n_3 \Bc.
\end{equation}
%
The primitive unit cell contains 1 lattice point.  In \citep{ashcroft1976solid} \textchapref{4} a distinction is made between a Bravais lattice structure, and a Bravais lattice basis \eqnref{eqn:condensedMatterLecture4:120}.  The Bravais lattice is the smallest cell that can be repeated to recover the periodic structure.  This does not necessarily contain just a single atom.  Two Bravais lattice structure choices are illustrated for a 2D cubic centered lattice in \cref{fig:2dcubicCenteredBravais:2dcubicCenteredBravaisFig1}.  These are both two point lattice structures, with one containing two whole atoms, and the other containing one whole atom and four quarter atoms.
%
\imageFigure{../figures/phy487-qmsolids/2dcubicCenteredBravaisFig1}{Two Bravais lattice choices for 2D cubic centered.}{fig:2dcubicCenteredBravais:2dcubicCenteredBravaisFig1}{0.2}
...
%
\imageFigure{../figures/phy487-qmsolids/HexClosePackingFig1}{Hex close packing.}{fig:HexClosePacking:HexClosePackingFig1}{0.2}
...
%
\imageFigure{../figures/phy487-qmsolids/qmSolidsL4Fig4}{D orbital bonding in a plane.}{fig:qmSolidsL4:qmSolidsL4Fig4}{0.2}
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture4:20a}
\mbox{8 corners \(\times \inv{8}\) = 1 atoms}
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture4:40a}
...
\imageFigure{../figures/phy487-qmsolids/qmSolidsL4Fig6}{Large extent of \(n s\) orbitals.}{fig:qmSolidsL4:qmSolidsL4Fig6}{0.2}
