...
%
\begin{equation}\label{eqn:condensedMatterLecture7:60}
...
\begin{equation}\label{eqn:condensedMatterLecture7:180}
f_\alpha = 
\int \rho_\alpha(\Br')
e^{-i \BG_{h k l} \cdot \Br} d\Br'.
\end{equation}
...
%}
%
\begin{equation}\label{eqn:condensedMatterLecture7:80}
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture7:100}
\Br_1 =
\begin{bmatrix}
0 \\
0 \\
...
\end{bmatrix}
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture7:120}
\Br_2 =
\frac{a}{2}
\begin{bmatrix}
1 \\
...
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterLecture7:160}
S_{h k l} = f (
\mathLabelBox
[
