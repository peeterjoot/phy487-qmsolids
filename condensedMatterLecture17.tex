...
%
\section{3D band structures, Fermi surfaces of real metals.}
...
%
\imageFigure{../figures/phy487-qmsolids/qmSolidsLecture17Fig1}{Simple cubic Brillouin zone.}{fig:qmSolidsLecture17:qmSolidsLecture17Fig1}{0.2}
%\cref{fig:qmSolidsLecture17:qmSolidsLecture17Fig2}.
\imageFigure{../figures/phy487-qmsolids/qmSolidsLecture17Fig2}{Two frequency distributions.}{fig:qmSolidsLecture17:qmSolidsLecture17Fig2}{0.3}
%\cref{fig:qmSolidsLecture17:qmSolidsLecture17Fig3}.
\imageFigure{../figures/phy487-qmsolids/qmSolidsLecture17Fig3}{Center edge contour distribution.}{fig:qmSolidsLecture17:qmSolidsLecture17Fig3}{0.2}
...
In 1 band \(\ifrac{ (2 \pi)^3}{a^3}\) is the volume of k-space, and we have
%
\begin{equation}\label{eqn:condensedMatterLecture17:20}
%%\mathLabelBox
%%[
...
%\imageFigure{../figures/phy487-qmsolids/qmSolidsLecture17Fig4}{4: CAPTION}{fig:qmSolidsLecture17:qmSolidsLecture17Fig4}{0.3}
%\cref{fig:qmSolidsLecture17:qmSolidsLecture17Fig5}.
%\imageFigure{../figures/phy487-qmsolids/qmSolidsLecture17Fig5}{5: CAPTION}{fig:qmSolidsLecture17:qmSolidsLecture17Fig5}{0.3}
for
%
\begin{equation}\label{eqn:condensedMatterLecture17:40}
2 \frac{V}{a^3} = 2 N,
\end{equation}
%
...
%F7
%F8 ...
\imageFigure{../figures/phy487-qmsolids/qmSolidsLecture17Fig6}{Fermi surfaces for \ce{Cu} like simple cubic.}{fig:qmSolidsLecture17:qmSolidsLecture17Fig6}{0.3}
%\cref{fig:qmSolidsLecture17:qmSolidsLecture17Fig7}.
\imageFigure{../figures/phy487-qmsolids/qmSolidsLecture17Fig7}{Copper Fermi surface side view?.}{fig:qmSolidsLecture17:qmSolidsLecture17Fig7}{0.3}
...
%
\imageFigure{../figures/phy487-qmsolids/qmSolidsLecture17Fig8}{d electron distribution.}{fig:qmSolidsLecture17:qmSolidsLecture17Fig8}{0.3}
...
The reason that copper is copper coloured is because there's a high density of states, with absorption in blue, resulting in a brown look.
