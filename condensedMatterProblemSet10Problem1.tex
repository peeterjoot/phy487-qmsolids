...
The density of point-like impurities in a metal can be characterized by a `mean free path,' \(l_\nought\), of the conduction electrons, this being the distance between scattering centers that randomize the velocity.
\index{mean free path}
\index{Drude model}
\makesubproblem{}{condensedMatter:problemSet10:1a}
Assuming that electrons travel at the Fermi velocity between scattering centers in a
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet10Problem1:80}
\begin{aligned}
\sigma
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet10Problem1:140}
\begin{aligned}
\tau
&= \frac{l_\nought}{\vF}
