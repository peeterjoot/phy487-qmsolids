...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture21:20}
\Bj = \sigma \bcE
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture21:40}
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture21:60}
\inv{\tau_{\mathrm{ph}}(q)} \propto q^2 \expectation{n_q}
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture21:80}
...
%
\begin{equation}\label{eqn:condensedMatterLecture21:100}
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture21:120}
\inv{\tau_{\mathrm{ph}}} \propto  T
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture21:140}
\sigma \propto \inv{T}
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture21:160}
...
for
%
\begin{equation}\label{eqn:condensedMatterLecture21:200}
\inv{\tau_{\mathrm{ph}}} \propto
\lr{ \cdots } \lr{ \kB T }^5
\mathLabelBox
{
