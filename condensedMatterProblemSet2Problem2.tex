...
%
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem2:20}
\begin{aligned}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem2:60}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem2:260}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem2:100}
\begin{aligned}
r^2
&= a^2 - \lr{\frac{a}{2}}^2
\\ &= a^2 \lr{ 1 - \inv{4} },
...
%
or
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem2:120}
a = \frac{2 \sqrt{3} r}{ 3 }.
\end{equation}
%
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem2:140}
\begin{aligned}
h^2
&= \lr{2 r}^2 - a^2
\\ &= \lr{ 4 - \frac{4}{3} } r^2
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem2:160}
h = \sqrt{\frac{8}{3}} r.
\end{equation}
%
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem2:180}
A = 12 \times \sqrt{3} r^2,
\end{equation}
%
so that the total volume is
%
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem2:200}
\begin{aligned}
V
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem2:220}
\frac{
