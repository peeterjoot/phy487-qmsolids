...
\begin{itemize}
\item Type I, superconductivity collapses above \(H_{\txtc}\), sketched in \cref{fig:qmSolidsL23:qmSolidsL23Fig4}.
...
%
\begin{equation}\label{eqn:qmSL23:20}
m \dot{\Bv} = - e \bcE,
\end{equation}
%
and current density
%
\begin{equation}\label{eqn:qmSL23:40}
\Bj = - n_{\txts} e \Bv,
\end{equation}
%
for
%
\begin{equation}\label{eqn:qmSL23:60}
\PD{t}{\Bj} = \frac{n_{\txts} e^2}{m} \bcE,
\end{equation}
%
With Maxwell's third
%
\begin{equation}\label{eqn:qmSL23:80}
\spacegrad \cross \bcE = - \PD{t}{\BB},
\end{equation}
%
we have
%
\begin{equation}\label{eqn:qmSL23:100}
\PD{t}{} \lr{
...
\end{equation}
%
\makeexample{Solution for constant magnetic field.}{example:qmSL23:n}{
...
%
\begin{equation}\label{eqn:qmSL23:360}
\begin{aligned}
\spacegrad \cross \lr{ \spacegrad \cross \Bj }
...
electron density
%
\begin{equation}\label{eqn:qmSL23:340}
\begin{aligned}
\braket{\psi}{\psi} &=
\inv{L^3}
\lr{
