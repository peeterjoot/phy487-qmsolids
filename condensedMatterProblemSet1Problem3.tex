...
%
\makeoproblem{The Madelung constant.}{condensedMatter:problemSet1:3}{2013 ps1 p3}{
From: (Ibach and Luth, Q1, Chapter 1).
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet1Problem3:20}
\begin{aligned}
A_0
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet1Problem3:40}
A
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet1Problem3:60}
i^2 + j^2 + k^2 \le m^2.
\end{equation}
%
...
%
\paragraph{Grading remarks:} Lost marks for the underlined text above, with comment ``Explain specifically and in physical terms what this means.''  The posted solutions included a nice table that shows how the number of positive vs number of negative atoms in the lattice as \(m\) increases, and how that difference in the total charge difference oscillates wildly when we increase the spherical volume but very little when increasing the volume of the cube.
}
