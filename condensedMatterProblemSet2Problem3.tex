...
%
\makeoproblem{Lattice vectors and unit cell.}{condensedMatter:problemSet2:3}{2013 ps2 p3}{
%Lattice vectors, primitive vs. conventional unit cell.
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem3:20}
2 \Bc - \Ba - \Bb = 3 \zcap,
\end{equation}
%
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem3:40}
\begin{aligned}
V_{\mathrm{primitive}}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet2Problem3:60}
