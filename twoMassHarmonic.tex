...
%
\begin{equation}\label{eqn:twoMassHarmonic:20}
\LL =
...
%
\begin{equation}\label{eqn:twoMassHarmonic:40}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:60}
\begin{aligned}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:80}
\begin{aligned}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:100}
\begin{aligned}
M \BR_{\mathrm{CM}}(t)
&=
m_1 \Br_1 + m_2 \Br_2
...
%
\begin{equation}\label{eqn:twoMassHarmonic:120}
\mu = \frac{m_1 m_2}{m_1 + m_2},
\end{equation}
%
that oscillation equation is
%
\begin{equation}\label{eqn:twoMassHarmonic:140}
\frac{d^2}{dt^2}
\lr{ \Br_2 - \Br_1 }
= -\frac{K}{\mu}
\lr{ \Br_2 - \Br_1 }.
...
%
\begin{equation}\label{eqn:twoMassHarmonic:180}
\Delta \Br(t) =
...
%
\begin{equation}\label{eqn:twoMassHarmonic:200}
\begin{bmatrix}
-1 & 1 \\
m_1 & m_2
\end{bmatrix}
...
or
%
\begin{equation}\label{eqn:twoMassHarmonic:220}
\begin{bmatrix}
\Br_1 \\
\Br_2
\end{bmatrix}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:240}
\begin{aligned}
\Br_1(t) &=
-\frac{\mu}{m_1}
\Delta \Br(t)
...
\makeproblem{1D, non-zero equilibrium length.}{pr:twoMassHarmonic:2}{
...
%
\begin{equation}\label{eqn:twoMassHarmonic:22}
\LL =
...
%
\begin{equation}\label{eqn:twoMassHarmonic:61}
\begin{aligned}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:260}
\ddot{u} = -\frac{K}{\mu} u.
\end{equation}
%
Solving and back substituting for \(\Delta x(t) = x_2(t) - x_1(t)\), we have
%
\begin{equation}\label{eqn:twoMassHarmonic:280}
\Delta x(t)
=
a +
...
\makeproblem{3D non-zero equilibrium length.}{pr:twoMassHarmonic:3}{
...
%
\begin{equation}\label{eqn:twoMassHarmonic:21}
\begin{aligned}
\LL &=
   \inv{2} m_1 \lr{ \dot{\Br}_1 }^2
 + \inv{2} m_2 \lr{ \dot{\Br}_2 }^2
 - \frac{K}{2} \lr{ \Delta \Br - \Ba }^2 \\
&\quad+ \lambda \lr{ \Delta \Br - \lr{\acap \cdot \Delta \Br} \acap }^2.
\end{aligned}
\end{equation}
%
...
%
\begin{equation}\label{eqn:twoMassHarmonic:300}
\begin{aligned}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:380}
\begin{aligned}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:400}
\Delta \ddot{\Br} = - \frac{K}{\mu} \lr{ \Delta \Br - \Ba }.
\end{equation}
%
By inspection the solution for the difference is
%
\begin{equation}\label{eqn:twoMassHarmonic:420}
\begin{aligned}
\Delta \Br(t) &=
\Ba
+
...
\makeproblem{Equilibrium position constraint.}{pr:twoMassHarmonic:4}{
...
%
\begin{equation}\label{eqn:twoMassHarmonic:440}
\begin{aligned}
\LL
&=
\inv{2} m_1 \lr{ \dot{\Br}_1 }^2
...
%
so that
\begin{equation}\label{eqn:twoMassHarmonic:500}
\PD{\Bx}{\Abs{\Bx}} = \frac{\Bx}{\Abs{\Bx}}.
\end{equation}
%
This gives us
%
\begin{equation}\label{eqn:twoMassHarmonic:520}
\begin{aligned}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:560}
\begin{aligned}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:580}
...
\makeproblem{Potential about equilibrium point.}{pr:twoMassHarmonic:5}{
...
\begin{equation}\label{eqn:twoMassHarmonic:600}
\begin{aligned}
\phi(\Br_1, \Br_2)
&=
...
%
\begin{equation}\label{eqn:twoMassHarmonic:620}
\PD{r_{1i}}{\phi}
=
K \lr{
...
%
\begin{equation}\label{eqn:twoMassHarmonic:640}
\begin{aligned}
\PD{r_{1i}}{\phi}
&=
K
...
%
\begin{equation}\label{eqn:twoMassHarmonic:660}
\begin{aligned}
&\PD{r_{1j}}{}
\PD{r_{1i}}{\phi} \\
&=
...
%
\begin{equation}\label{eqn:twoMassHarmonic:680}
\evalbar{
\PD{r_{1j}}{}
\PD{r_{1i}}{\phi}
}{\Ba_1, \Ba_2}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:700}
\begin{aligned}
\evalbar{
\PD{r_{1j}}{}
\PD{r_{1i}}{\phi}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:661}
\begin{aligned}
&\PD{r_{2j}}{}
\PD{r_{1i}}{\phi} \\
&=
...
%
\begin{equation}\label{eqn:twoMassHarmonic:740}
\begin{aligned}
&\phi(\Bu_1, \Bu_2) 
\approx 
\phi(\Ba_1, \Ba_2) \\
...
%
\begin{equation}\label{eqn:twoMassHarmonic:780}
\begin{aligned}
\LL &=
...
%
\begin{equation}\label{eqn:twoMassHarmonic:800}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:820}
\begin{aligned}
\PD{u_{2k}}{\LL}
&=
- \frac{K}{2} \sum_{ij}
...
\begin{equation}\label{eqn:twoMassHarmonic:840}
\begin{aligned}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:880}
...
\makeproblem{Harmonically coupled masses.}{pr:twoMassHarmonic:6}{
...
%
\begin{equation}\label{eqn:twoMassHarmonic:900}
\begin{aligned}
\Ba_\Bn - \Ba_\Bm
&= \Delta \Ba_{\Bn \Bm} \\
&= \Abs{\Delta \Ba_{\Bn \Bm}} (
...
the Lagrangian is
%
\begin{equation}\label{eqn:twoMassHarmonic:920}
\begin{aligned}
\LL
...
%
\begin{equation}\label{eqn:twoMassHarmonic:940}
...
and
%
\begin{equation}\label{eqn:twoMassHarmonic:960}
\begin{aligned}
\PD{u_{\Bn k}}{\LL}
&=
-\sum_{\Bm, i, j}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:980}
m_\Bn \ddot{\Bu}_\Bn
=
-\sum_{\Bm}
K_{\Bn \Bm}
...
Let's write
%
\begin{equation}\label{eqn:twoMassHarmonic:1020}
\begin{aligned}
%\Br &= (a, b) \\
%\Bs &= (-a, b) \\
...
%
\begin{equation}\label{eqn:twoMassHarmonic:1040}
...
%
\begin{subequations}
\begin{equation}\label{eqn:twoMassHarmonic:1140}
\begin{aligned}
m_1 \ddot{\Bu}_{\Bn, 1}
&=
- K_1
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:twoMassHarmonic:1160}
\begin{aligned}
m_2 \ddot{\Bu}_{\Bn, 2} &=
- K_1
\Proj_\xcap
...
%
\begin{subequations}
\begin{equation}\label{eqn:twoMassHarmonic:1180}
\begin{aligned}
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:twoMassHarmonic:1200}
\begin{aligned}
...
%
\begin{subequations}
\begin{equation}\label{eqn:twoMassHarmonic:1220}
\begin{aligned}
&\Biglr{
\omega^2 - \\
&\quad \frac{2}{m_1} 
...
\end{aligned}
\end{equation}
%\begin{equation}\label{eqn:twoMassHarmonic:1240}
%\begin{aligned}
%\omega^2 \Bepsilon_2
%&=
%K_1
...
%\end{aligned}.
%\end{equation}
\begin{equation}\label{eqn:twoMassHarmonic:1260}
\begin{aligned}
&\Biglr{
\omega^2 \\
&\quad - \frac{2}{m_2}
...
\begin{equation}\label{eqn:twoMassHarmonic:1280}
A =
K_1 \xcap \xcap^T
+ K_2 \ycap \ycap^T
+ 2 K_3 \rcap \rcap^T \sin^2 (\Br \cdot \Bq/2)
+ 2 K_4 \scap \scap^T \sin^2 (\Bs \cdot \Bq/2)
\end{equation}
\begin{equation}\label{eqn:twoMassHarmonic:1300}
B =
e^{ i (\Br + \Bs) \cdot \Bq/2 }
\lr{
   K_1
...
\end{equation}
\begin{equation}\label{eqn:twoMassHarmonic:1320}
0 =
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:1061}
E =
\begin{bmatrix}
...
%
\begin{subequations}
\begin{equation}\label{eqn:twoMassHarmonic:1100}
\begin{aligned}
\Proj_\rcap
&= \rcap \rcap^\T
\\ &=
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:twoMassHarmonic:1120}
\begin{aligned}
\Proj_\scap
&= \scap \scap^\T
\\ &=
...
%
\begin{equation}\label{eqn:twoMassHarmonic:1380}
\begin{aligned}
...
%
\begin{subequations}
\begin{equation}\label{eqn:twoMassHarmonic:1400}
A =
\begin{bmatrix}
...
\end{bmatrix}
\end{equation}
\begin{equation}\label{eqn:twoMassHarmonic:1420}
B =
   e^{ i (\Br + \Bs) \cdot \Bq/2 }
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:twoMassHarmonic:1440}
\beta_\pm = K_1 \cos\lr{ a \cos\theta q_x } \pm K_2 \cos\lr{ a \sin\theta q_y },
\end{equation}
%
and
%
\begin{equation}\label{eqn:twoMassHarmonic:1480}
B =
   e^{ i a \sin\theta q_y }
\begin{bmatrix}
   \beta_+ (1 + \cos \lr{ 2 \theta }) & \beta_- \sin \lr{ 2 \theta } \\
