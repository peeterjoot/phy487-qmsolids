...
%
\begin{equation}\label{eqn:condensedMatterLecture6:20}
I(\BK)
=
\frac{\Abs{A_\nought}^2}{{R'}^2}
\Abs{
...
%
\begin{equation}\label{eqn:condensedMatterLecture6:40}
I(\BK)
=
\frac{\Abs{A_\nought}^2}{{R'}^2}
\Abs{
...
When
%
\begin{equation}\label{eqn:condensedMatterLecture6:60}
\BK = \Bk - \Bk_\nought = \BG.
\end{equation}
%
the integrand is unity (so the integral is the area of the diffraction aperture), whereas if
%
\begin{equation}\label{eqn:condensedMatterLecture6:80}
\BK \ne \BG.
\end{equation}
%
...
In particular
%
\begin{equation}\label{eqn:condensedMatterLecture6:40b}
I(\BK = \BG)
=
\frac{\Abs{A_\nought}^2}{{R'}^2}
\Abs{
...
%
\begin{equation}\label{eqn:condensedMatterLecture6:120}
(1 \times \Ba_1, \infty \times \Ba_2, \infty \times \Ba_3).
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterLecture6:140}
\lr{ \frac{p}{1}, \frac{p}{\infty}, \frac{p}{\infty} }.
\end{equation}
%
with \(p = 1\) this gives Miller indices of
\begin{equation}\label{eqn:condensedMatterLecture6:160}
\lr{ 1, 0, 0}.
\end{equation}
}
...
We use
%
\begin{equation}\label{eqn:condensedMatterLecture6:180}
\BG_{hkl} =
j \Bg_1 +
k \Bg_2 +
l \Bg_3,
...
%
\begin{equation}\label{eqn:condensedMatterLecture6:200}
\begin{aligned}
...
%
\begin{equation}\label{eqn:condensedMatterLecture6:220}
\begin{aligned}
%\perp
&\propto
...
%
\begin{equation}\label{eqn:condensedMatterLecture6:300}
\begin{aligned}
...
%
\begin{equation}\label{eqn:condensedMatterLecture6:240a}
\begin{aligned}
d'_{hkl}
...
\begin{equation}\label{eqn:condensedMatterLecture6:240}
d_{hkl} =
\frac{d'_{hkl}}{p} =
\frac{2 \pi}{ G_{hkl} },
\end{equation}
...
%
\imageFigure{../figures/phy487-qmsolids/qmSolidsL6Fig10}{Primitive cell replication and all the Miller 122 planes.}{fig:qmSolidsL6:qmSolidsL6Fig10}{0.3}
...
Observe that
\begin{equation}\label{eqn:condensedMatterLecture6:260a}
