...
%
\begin{equation}\label{eqn:condensedMatterProblemSet6Problem2:80}
\frac{X''}{X}
+\frac{Y''}{Y}
+\frac{Z''}{Z}
=
...
Our solution is
%
\begin{equation}\label{eqn:condensedMatterProblemSet6Problem2:140}
\Psi = A
\sin\lr{ k_x (x - a)}
\sin\lr{ k_y y }
\sin\lr{ k_z z },
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet6Problem2:220}
\Psi = \inv{\sqrt{a} L}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet6Problem2:240}
\begin{aligned}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet6Problem2:360}
\begin{aligned}
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet6Problem2:380}
\begin{aligned}
dk_z
&=
...
%
\begin{equation}\label{eqn:condensedMatterProblemSet6Problem2:400}
L \int D(E) dE =
\frac{4 L}{\pi}
\int
\inv{\Hbar} \sqrt{\frac{m}{2 E}} dE,
