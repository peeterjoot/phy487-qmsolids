...
In microelectronics the scale of charge carrying conductive pathways are reduced so much that ``wires'' can exhibit quantum mechanical effects.  When the scale of such wires are reduced enough, modelling that conduit as a 1D particle in a box as above is likely possible.  A carbon nanotube is likely another possible physical implementation of a 1D particle in a box.
