...
%
\begin{equation}\label{eqn:condensedMatterLecture11:20}
-\frac{\Hbar^2}{2 m} \spacegrad^2 \Psi(\Br) + V(\Br) \Psi(\Br) = E \Psi(\Br),
\end{equation}
%
where
%
\begin{equation}\label{eqn:condensedMatterLecture11:40}
V(\Br) =
\left\{
\begin{array}{l l}
...
%
\begin{equation}\label{eqn:condensedMatterLecture11:60}
-\frac{\Hbar^2}{2 m} \lr{
\PDSq{x}{}
+\PDSq{y}{}
+\PDSq{z}{}
...
%
\begin{equation}\label{eqn:condensedMatterLecture11:80}
-\frac{\Hbar^2}{2 m}
\PDSq{x}{\Psi_x(x)}
=
E_x
...
where
%
\begin{equation}\label{eqn:condensedMatterLecture11:100}
\Psi_x(0) = \Psi_x(L) = 0.
\end{equation}
%
Our solution is
%
\begin{equation}\label{eqn:condensedMatterLecture11:120}
\Psi(x) = N \sin( k_x x ),
\end{equation}
%
where
%
\begin{equation}\label{eqn:condensedMatterLecture11:140}
k_x = \frac{ n_x \pi}{L}.
\end{equation}
%
In 3D this is
%
\begin{equation}\label{eqn:condensedMatterLecture11:160}
\Psi(\Br) =
\lr{\frac{2}{L}}^{3/2}
\sin( k_x x )
\sin( k_y y )
...
%
where
\begin{equation}\label{eqn:condensedMatterLecture11:180}
\begin{aligned}
E(\Bk)
&= \frac{\Hbar}{2m} \lr{
k_x^2
...
%
\begin{equation}\label{eqn:condensedMatterLecture11:220}
...
%
\begin{equation}\label{eqn:condensedMatterLecture11:240}
\begin{aligned}
...
%
\begin{equation}\label{eqn:condensedMatterLecture11:260}
E = \frac{\Hbar^2 k^2}{2m},
\end{equation}
%
so that
\begin{equation}\label{eqn:condensedMatterLecture11:280}
dE = \frac{\Hbar^2 k}{m} dk.
\end{equation}
%
This gives
%
\begin{equation}\label{eqn:condensedMatterLecture11:300}
\begin{aligned}
k^2 dk &=
...
%
so that
\begin{equation}\label{eqn:condensedMatterLecture11:320}
\begin{aligned}
\sum_{k_x, k_y, k_z, \mathrm{spin}}
&\rightarrow
...
%
\begin{equation}\label{eqn:condensedMatterLecture11:340}
D(E) =
...
so that
%
\begin{equation}\label{eqn:condensedMatterLecture11:380}
\kF = \lr{ 3 \pi^2 n}^{1/3},
\end{equation}
%
where
%
\begin{equation}\label{eqn:condensedMatterLecture11:400}
n \equiv \frac{N}{V}.
\end{equation}
%
...
%
\begin{equation}\label{eqn:condensedMatterLecture11:380b}
\begin{aligned}
\EF
&= \frac{ \Hbar^2 \kF^2 }{2m}
