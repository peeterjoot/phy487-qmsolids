...
%
\begin{equation}\label{eqn:condensedMatterLecture20:20}
\Hbar \dot{\Bk} = - e \bcE.
\end{equation}
%
...
%
\begin{equation}\label{eqn:condensedMatterLecture20:60}
\begin{aligned}
j_x
...
With
%
\begin{equation}\label{eqn:condensedMatterLecture20:80}
\vF = \frac{\Hbar \kF}{m^\conj},
\end{equation}
%
this is
%
\begin{equation}\label{eqn:condensedMatterLecture20:100}
j_x \approx
\frac{e^2\tau}{m^\conj} \frac{\kF^3}{3 \pi^2} \calE_x.
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterLecture20:120}
...
where
%
\begin{equation}\label{eqn:condensedMatterLecture20:160}
v_{\text{drift}} = \lr{ \text{acceleration} } \tau = -\frac{e \calE}{m} \tau,
\end{equation}
%
so that
%
\begin{equation}\label{eqn:condensedMatterLecture20:180}
