...
%
\begin{equation}\label{eqn:condensedMatterLecture9:20}
m \ddot{u} = -k u,
\end{equation}
%
results in a single frequency
%
\begin{equation}\label{eqn:condensedMatterLecture9:40}
\omega = \sqrt{\frac{k}{m}}.
\end{equation}
%
...
%
\begin{equation}\label{eqn:condensedMatterLecture9:60}
\epsilon_n = \lr{ n + \inv{2} } \Hbar \omega.
\end{equation}
%
For lattices we've been seeking solutions of the force equations
%
\begin{equation}\label{eqn:condensedMatterLecture9:80}
...
%
\begin{equation}\label{eqn:condensedMatterLecture9:100}
...
%
\begin{equation}\label{eqn:condensedMatterLecture9:120}
U(T) = \mathLabelBox
[
...
%
\begin{equation}\label{eqn:condensedMatterLecture9:140}
...
or
%
\begin{equation}\label{eqn:condensedMatterLecture9:160}
q_x L_x = 2 \pi l,
%\Bq \cdot \Br_n = 2 \pi l,.
\end{equation}
%
...
%
\begin{equation}\label{eqn:condensedMatterLecture9:180}
...
%
\begin{equation}\label{eqn:condensedMatterLecture9:200}
\frac{2 \pi}{L_x}
\frac{2 \pi}{L_y}
\frac{2 \pi}{L_z}
= \frac{\lr{ 2 \pi }^3 }{V}.
...
%
\begin{equation}\label{eqn:condensedMatterLecture9:220}
\begin{aligned}
\sum_\Bn
&=
\sum_{n_x}
...
%
\begin{equation}\label{eqn:condensedMatterLecture9:240}
df_\omega dq_\perp.
\end{equation}
%
We can write
%
\begin{equation}\label{eqn:condensedMatterLecture9:260}
dq_\perp = \frac{d\omega}{\Abs{\spacegrad_\Bq \omega(\Bq) }},
\end{equation}
%
or
%
\begin{equation}\label{eqn:condensedMatterLecture9:280}
\begin{aligned}
\frac{V}{(2\pi)^3 } \int d^3\Bq
&\rightarrow
...
%
\begin{equation}\label{eqn:condensedMatterLecture9:300}
...
%
\begin{equation}\label{eqn:condensedMatterLecture9:320}
\spacegrad_\Bq \omega(q) = \frac{d\omega}{dq} \qcap,
\end{equation}
%
at small \(q\), the frequency for this 1 atom basis is
%
\begin{equation}\label{eqn:condensedMatterLecture9:340}
\omega =
\left\{
\begin{array}{l l}
...
This gives
%
\begin{equation}\label{eqn:condensedMatterLecture9:360}
\begin{aligned}
\int Z(\omega) d\omega
&=
...
%
\begin{equation}\label{eqn:condensedMatterLecture9:420}
...
%
\begin{equation}\label{eqn:condensedMatterLecture9:380}
...
%
\begin{equation}\label{eqn:condensedMatterLecture9:400}
\begin{aligned}
3 r N
&=
