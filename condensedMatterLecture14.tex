...
%
\begin{equation}\label{eqn:condensedMatterLecture14:20}
\lr{
...
%
\begin{equation}\label{eqn:condensedMatterLecture14:40}
\Br_n =
n_1 \Ba_1
+ n_2 \Ba_2
+ n_3 \Ba_3,
...
so that
%
\begin{equation}\label{eqn:condensedMatterLecture14:60}
...
%
\begin{subequations}
\begin{equation}\label{eqn:condensedMatterLecture14:80}
\BG =
h \Bg_1
+ k \Bg_2
+ l \Bg_3
\end{equation}
\begin{equation}\label{eqn:condensedMatterLecture14:100}
...
%
\begin{equation}\label{eqn:condensedMatterLecture14:120}
\Psi(\Br) = \sum_\Bk C_\Bk e^{i \Bk \cdot \Br },
\end{equation}
%
\begin{equation}\label{eqn:condensedMatterLecture14:140}
...
%
\begin{equation}\label{eqn:condensedMatterLecture14:200}
0 =
\sum_{\Bk' }
\lr{
...
Using
%
\begin{equation}\label{eqn:condensedMatterLecture14:220}
\int d\Br e^{ -i (\Bk' - \Bk) \cdot \Br } \propto \delta(\Bk' - \Bk),
\end{equation}
%
and operating with
\begin{equation}\label{eqn:condensedMatterLecture14:240}
...
%
\begin{equation}\label{eqn:condensedMatterLecture14:280}
\Psi \sim
C_k e^{i k x}
...
\end{subequations}
%
\begin{equation}\label{eqn:condensedMatterLecture14:340}
\begin{aligned}
\Psi_\Bk(\Br)
...
%
\begin{equation}\label{eqn:condensedMatterLecture14:380}
\Psi_{\Bk + \BG}(\Br)
=
...
With
%
\begin{equation}\label{eqn:condensedMatterLecture14:400}
\BG'' = \BG' - \BG,
\end{equation}
%
this is
%
\begin{equation}\label{eqn:condensedMatterLecture14:420}
\begin{aligned}
\Psi_{\Bk + \BG}(\Br)
&=
\sum_{\BG''} C_{\Bk - \BG''} e^{ i (\Bk - \BG'') \cdot \Br}
...
%
\begin{equation}\label{eqn:condensedMatterLecture14:460}
\begin{aligned}
...
\mathImageFigure{../figures/phy487-qmsolids/nearlyFreeFig1}{Periodic energy solutions.}{fig:qmSolidsL14:qmSolidsL14Fig3}{0.3}{nearlyFreeFig1Generatedlabeled.nb}
...
\begin{tablelabelbox}[tabularx={X|X|X|X|X}]
{Bloch's theorem spelled out}
{label=qmSolidsL14:tab:1}
...
%    \hline
    ...
    2 & \(\inv{\sqrt{L}} e^{i (k - 2 \pi/a)k x}\)             & \(\frac{e^{-2 \pi x/a}}{\sqrt{L}}\)                     & \(\frac{\Hbar^2 (k - 2 \pi/a)^2}{2m}\)              & \(C_{k - 2 \pi/a} = 1 
%; \text{all others zero}
\) \\
    3 & \(\inv{\sqrt{L}} e^{i (k + 2 \pi/a)k x}\)             & \(\frac{e^{2 \pi x/a}}{\sqrt{L}}\)                     & \(\frac{\Hbar^2 (k + 2 \pi/a)^2}{2m}\)              & \(C_{k + 2 \pi/a} = 1 
%; \text{all others zero}
\) \\
\hline
%    \end{tabular}
