...
%
\makeoproblem{Bonding, structure, melting points.}{condensedMatter:problemSet2:1}{2013 ps2 p1}{
...
The maximum melting points are found in the neighbourhood of these half filled orbital states, and decrease towards the completely filled orbital states on either side (or the column 1 elements which are fairly close to completely filled) as one progresses up or down the period.
