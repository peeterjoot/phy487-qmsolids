...
%
\mathImageFigure{../figures/phy487-qmsolids/qmSolidsL19Fig1}{Gaussian wave packet.}{fig:qmSolidsL19:qmSolidsL19Fig1}{0.2}{guassianPlotsL18L19.nb}
%
\begin{equation}\label{eqn:condensedMatterLecture19:20}
...
For tight binding
%
\begin{equation}\label{eqn:condensedMatterLecture19:60}
E(k) = E_i - A - 2 B \cos k a.
\end{equation}
%
so that
%
\begin{equation}\label{eqn:condensedMatterLecture19:80}
...
%
\begin{equation}\label{eqn:condensedMatterLecture19:120}
\begin{aligned}
E(\Bk)
...
%
\begin{equation}\label{eqn:condensedMatterLecture19:140}
...
%
\begin{equation}\label{eqn:condensedMatterLecture19:180}
\begin{aligned}
\vdot_i
...
This time we call
%
\begin{equation}\label{eqn:condensedMatterLecture19:200}
\lr{ \inv{m^\conj} }_{i j}
= \inv{\Hbar^2}
...
%
\begin{equation}\label{eqn:condensedMatterLecture19:220}
\begin{aligned}
\Bj
...
%
\begin{equation}\label{eqn:condensedMatterLecture19:260}
\sum \Bv(\Bk) = 0.
\end{equation}
%
%\EndArticle
